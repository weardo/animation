...
**Date:** 2026-06-22
**Status:** In build — M1 complete; **M2 complete (vocabulary fast-track, 2026-06-22)**; M3 next. **§0 reconciles the spec with what's actually built** (the design evolved via `docs/factory/ADR-001`, `ADR-002`, and `docs/factory/DECISIONS.md`).
...
- **LATER (M3):** audio + sound design (P4/P7) · LLM script-expander (P1) · smart layout (P6/P9) · `post[]` grade · AI asset-gen (P3) · **Tier-B GPU enablement** (GL Transitions / Pixi filters / three / skia, gated on deterministic GPU capture) · small follow-ups (per-silhouette form-shade, far-layer atmospheric tint, OTIO export, `factory bundle`/`list`).
